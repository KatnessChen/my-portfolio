export const profile = {
  ...
  bioLong: [
    ...
    'Right now I am building my own SaaS, which means stepping well outside the engineer\'s comfort zone. It is harder and considerably more interesting.',
  ],
